"""Configure the Windows cx_Freeze application build."""
...
PYMOL_PACKAGE_DIR = Path(PROJECT_ROOT_DIR / ".venv/Lib/site-packages/pymol")
  ...
  executables=[
    {
      ...
      "base": "gui",
      "icon": Path(PROJECT_ROOT_DIR / "os_specific/windows" / "logo.ico"),
    }
  ],
)
